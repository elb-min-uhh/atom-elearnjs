...
*/
function OptionMenu(opts) {
    if(!opts.callback || typeof opts.callback !== "function") return null;
...
OptionMenu.prototype.getElement = function() {
    return this.element;
};
...
*               - 1: ok
*/
OptionMenu.prototype.close = function(val) {
...
OptionMenu.prototype.initHeader = function(header) {
    if(!header) return;
...
OptionMenu.prototype.initButtons = function(buttons) {
    const self = this;
...
OptionMenu.prototype.selectDefaultButton = function() {
